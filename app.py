...
def init_model(vlm_config, device, model_path):
    ...
    model = NanoTabVLM(vlm_config, vision_model_path="./model/vision_model/siglip2-base-patch16-512")
...
def chat(current_image_path):
    ...
    pixel_values = NanoTabVLM.image2tensor(image, preprocess).to(model.device).unsqueeze(0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default="checkpoint/nano_vlm_512_moe.pth", type=str)
